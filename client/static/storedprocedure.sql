...
INSERT INTO `cleanair`.`journey` (`userId`, `startTime`, `endTime`) VALUES ('1', '2019-03-29 20:57:09', '2019-03-29 20:57:09');
...
BEGIN
  ...
  WHILE i <= 1000 DO
    ...
    VALUES (1,1,rand()*20,rand()*20,1,1,'2019-03-29 20:57:09', -3.21+0.08*rand(), 51.445+rand()*0.05);
    SET i = i + 1;
  END WHILE;
END$$
DELIMITER ;
